...
export default function Navbar() {
    ...
    return (
        <header
            className={`fixed w-full z-30 bg-opacity-30 transition duration-300 ease-in-out ${!top && "bg-white backdrop-filter backdrop-blur-lg shadow-lg"
                }`}
        >
                ...
                <div className="flex items-center justify-between h-16 md:h-20">
                    ...
                    <nav className="hidden md:flex md:flex-grow">
                        <div className="flex flex-grow justify-end flex-wrap items-center">
                               <button className="bg-orange rounded-md py-2 px-2 text-white font-semibold animate-bounce">
                        ...
                        {/* <ul className="flex flex-grow justify-end flex-wrap items-center">
                            <li>
                                ...
                                >
                                    <span>Transportasi Lintsas Papua</span>
                                    <svg
